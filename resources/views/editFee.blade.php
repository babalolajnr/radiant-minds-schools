                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <form id="" method="POST" action="{{ route('fee.update', ['fee' => $fee]) }}">
                                @csrf
                                @method('Patch')
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="" class="form-control"
                                            value="{{ $fee->classroom->name }}" disabled>

                                    </div>
                                    <div class="form-group">
                                        <label for="Period">Period</label>
                                        <input type="text" name="" class="form-control"
                                            value="{{ $fee->period->academicSession->name }} {{ $fee->period->term->name }}" disabled>
                                    </div>
